...
export const gameStore = {
  ...
  // Fonctions utilitaires D&D - Seuils XP calibrés pour progression rapide (2-4 combats par niveau)
  getXPForNextLevel: (level: number): number => {
    // Seuils adaptés aux récompenses XP des monstres CR Eternalys (25-500 XP au début)
    ...
    return Math.floor(12500 * Math.pow(1.12, level - 20));
  },
